...
class ReservoirComputing:
    def __init__(self, num_neuron=3000, spectral_radius=0.4, sigma=0.5, sparsity=0.98, beta=0.0001):
...
plt.subplot(3, 1, 1)
plt.imshow(U.transpose(), aspect='auto', origin='lower', cmap='jet', vmin=-2, vmax=2, extent=[0, t[-1], 0, x[-1]])
plt.xlim([t[0], t[-1]])
plt.ylim([x[0], x[-1]])
plt.xlabel("t")
plt.ylabel("x")
...
plt.subplot(3, 1, 2)
plt.imshow(combined_reservoir_states, aspect='auto', origin='lower', cmap='jet', vmin=-2, vmax=2, extent=[0, t[-1], 0, x[-1]])
plt.xlim([t[0], t[-1]])
plt.ylim([x[0], x[-1]])
plt.xlabel("t")
plt.ylabel("x")
...
plt.subplot(3, 1, 3)
plt.imshow(U.transpose() - combined_reservoir_states, aspect='auto', origin='lower', cmap='jet', vmin=-2, vmax=2, extent=[0, t[-1], 0, x[-1]])
plt.xlim([t[0], t[-1]])
plt.ylim([x[0], x[-1]])
plt.xlabel("t")
plt.ylabel("x")
